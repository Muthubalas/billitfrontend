...
export class AddcustomerComponent implements OnInit {
  ...
  private dialog:MatDialogRef<AddcustomerComponent>,
  ) {
...
if(this.cusphno){
  ...
  this.cusphno=cusphno.trim()
}

let cusgender=this.cusgender?this.cusgender:'';
// let cusaddress=this.cusaddress?this.cusaddress:'';
    if(cusname != '' && this.cusphno != '' && this.cusphno!=undefined && cusgender != '' ){

      var data={
        customer_name:cusname,
        customer_phone:this.cusphno,
