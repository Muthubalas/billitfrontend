...
@Component({
  selector: 'app-addsaloninvent',
  templateUrl: './addsaloninvent.component.html',
  styleUrls: ['./addsaloninvent.component.css']
})
export class AddsaloninventComponent implements OnInit {
  getpro: any;
  select: any;
  ...
  private dialog:MatDialogRef<AddsaloninventComponent>,private router:Router) { }
